[![Run App Ethan Gunderson](https://github.com/egunde/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/egunde/GithubActions/actions/workflows/run-app.yaml)
